...
library(reshape2)
library(dplyr)
tmp <- getURL("https://raw.githubusercontent.com/dspim/a1-basic-data-analysis-course/master/data/weather-utf8.csv")
...
```{r make_table, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
